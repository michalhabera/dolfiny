...
def mesh_iso6892_gmshapi(name="iso6892", l0=0.10, d0=0.02, nr=5, x0=0.0, y0=0.0, z0=0.0,
                         do_hexes=False, order=1, msh_file=None, comm=MPI.COMM_WORLD):
    """
    ...
    if comm.rank == 0:
        ...
        gmsh.model.occ.rotate([(tdim, takeout1)], x0 - (l0 + d0) / 2, y0, z0, 0.0, 1.0, 0.0, gmsh.pi / 2)
        gmsh.model.occ.rotate([(tdim, takeout2)], x0 + (l0 + d0) / 2, y0, z0, 0.0, 1.0, 0.0, gmsh.pi / 2)
